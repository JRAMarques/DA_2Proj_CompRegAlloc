...
int main(int argc, char* argv[]) {
    ...
    if (isBatchMode) {
        ...
        // for testing purposes, let's assume default files if the user didn't provide them
        rangesFile = (argc > 1) ? argv[1] : "../ranges/ranges_example.txt";
        registersFile = (argc > 2) ? argv[2] : "../registers/registers_example.txt";
        ...
        while (option != 0) {
            ...
            switch (option) {
                case 1:
                    ...
                    // TODO: call allocator functions once implemented
                    break;
                case 2:
